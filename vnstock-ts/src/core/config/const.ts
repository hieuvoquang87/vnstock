...
export const API_ENDPOINTS = {
  ...
  [DataSource.TCBS]: {
    ...
    history: '/stock-insight/v1/stock/historical',
    intraday: '/stock-insight/v1/stock/intraday',
    ...
    ownership: '/stock-insight/v1/company/ownership',
    screener: '/stock-insight/v1/screener',
    news: '/news-service/v1/news',
  },
  [DataSource.SSI]: {
